...
func cerbos_engine_v1_PlanResourcesAst_LogicalOperation_hashpb_sum(m *PlanResourcesAst_LogicalOperation, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.engine.v1.PlanResourcesAst.LogicalOperation.operator"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetOperator())))
	}
	if _, ok := ignore["cerbos.engine.v1.PlanResourcesAst.LogicalOperation.nodes"]; !ok {
		if len(m.Nodes) > 0 {
			for _, v := range m.Nodes {
				if v != nil {
					cerbos_engine_v1_PlanResourcesAst_Node_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
		...
		if _, ok := ignore["cerbos.engine.v1.PlanResourcesAst.Node.node"]; !ok {
			...
			case *PlanResourcesAst_Node_LogicalOperation:
				if t.LogicalOperation != nil {
					cerbos_engine_v1_PlanResourcesAst_LogicalOperation_hashpb_sum(t.LogicalOperation, hasher, ignore, b)
				}
			case *PlanResourcesAst_Node_Expression:
				if t.Expression != nil {
					google_api_expr_v1alpha1_CheckedExpr_hashpb_sum(t.Expression, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_engine_v1_PlanResourcesAst_hashpb_sum(m *PlanResourcesAst, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.engine.v1.PlanResourcesAst.filter_ast"]; !ok {
		if m.GetFilterAst() != nil {
			cerbos_engine_v1_PlanResourcesAst_Node_hashpb_sum(m.GetFilterAst(), hasher, ignore, b)
		}
	}
}
...
func cerbos_engine_v1_Request_hashpb_sum(m *Request, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.engine.v1.Request.principal"]; !ok {
		if m.GetPrincipal() != nil {
			cerbos_engine_v1_Request_Principal_hashpb_sum(m.GetPrincipal(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.engine.v1.Request.resource"]; !ok {
		if m.GetResource() != nil {
			cerbos_engine_v1_Request_Resource_hashpb_sum(m.GetResource(), hasher, ignore, b)
		}
	}
	...
	if _, ok := ignore["cerbos.engine.v1.TraceBatch.definitions"]; !ok {
		if len(m.Definitions) > 0 {
			for _, v := range m.Definitions {
				if v != nil {
					cerbos_engine_v1_Trace_Component_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.engine.v1.TraceBatch.entries"]; !ok {
		if len(m.Entries) > 0 {
			for _, v := range m.Entries {
				if v != nil {
					cerbos_engine_v1_TraceEntry_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_engine_v1_TraceEntry_hashpb_sum(m *TraceEntry, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.engine.v1.TraceEntry.event"]; !ok {
		if m.GetEvent() != nil {
			cerbos_engine_v1_Trace_Event_hashpb_sum(m.GetEvent(), hasher, ignore, b)
		}
	}
}
	...
	if m.Details != nil {
		if _, ok := ignore["cerbos.engine.v1.Trace.Component.details"]; !ok {
			...
			case *Trace_Component_DerivedRole:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.DerivedRole))))
				_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(t.DerivedRole), len(t.DerivedRole)))
			case *Trace_Component_Expr:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.Expr))))
				_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(t.Expr), len(t.Expr)))
			case *Trace_Component_Index:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(t.Index)))
			case *Trace_Component_Policy:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.Policy))))
...
func cerbos_engine_v1_Trace_Event_hashpb_sum(m *Trace_Event, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.engine.v1.Trace.Event.result"]; !ok {
		if m.GetResult() != nil {
			google_protobuf_Value_hashpb_sum(m.GetResult(), hasher, ignore, b)
		}
	}
}
