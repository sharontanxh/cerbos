...
func cerbos_audit_v1_AccessLogEntry_hashpb_sum(m *AccessLogEntry, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.audit.v1.AccessLogEntry.oversized"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], protowire.EncodeBool(m.GetOversized())))
	}
	if _, ok := ignore["cerbos.audit.v1.AccessLogEntry.policy_source"]; !ok {
		if m.GetPolicySource() != nil {
			cerbos_audit_v1_PolicySource_hashpb_sum(m.GetPolicySource(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.audit.v1.AccessLogEntry.request_context"]; !ok {
		if m.GetRequestContext() != nil {
			cerbos_audit_v1_RequestContext_hashpb_sum(m.GetRequestContext(), hasher, ignore, b)
		}
	}
}
...
func cerbos_audit_v1_PolicySource_Blob_hashpb_sum(m *PolicySource_Blob, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.audit.v1.PolicySource.Blob.bucket_url"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetBucketUrl()))))
...
func cerbos_audit_v1_PolicySource_Database_hashpb_sum(m *PolicySource_Database, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.audit.v1.PolicySource.Database.driver"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetDriver())))
	}
}
...
func cerbos_audit_v1_PolicySource_Disk_hashpb_sum(m *PolicySource_Disk, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.audit.v1.PolicySource.Disk.directory"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetDirectory()))))
...
func cerbos_audit_v1_PolicySource_Git_hashpb_sum(m *PolicySource_Git, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.audit.v1.PolicySource.Git.repository_url"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetRepositoryUrl()))))
	...
	if _, ok := ignore["cerbos.audit.v1.PolicySource.Git.branch"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetBranch()))))
	...
	if m.Source != nil {
		if _, ok := ignore["cerbos.audit.v1.PolicySource.Hub.source"]; !ok {
			...
			case *PolicySource_Hub_Label:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.Label))))
			...
			case *PolicySource_Hub_PlaygroundId:
				_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(t.PlaygroundId))))
			...
			case *PolicySource_Hub_LocalBundle_:
				if t.LocalBundle != nil {
					cerbos_audit_v1_PolicySource_Hub_LocalBundle_hashpb_sum(t.LocalBundle, hasher, ignore, b)
				}
			...
			case *PolicySource_Hub_RemoteBundle_:
	...
	if m.Source != nil {
		if _, ok := ignore["cerbos.audit.v1.PolicySource.source"]; !ok {
			...
			case *PolicySource_Blob_:
				if t.Blob != nil {
					cerbos_audit_v1_PolicySource_Blob_hashpb_sum(t.Blob, hasher, ignore, b)
				}
			case *PolicySource_Database_:
				if t.Database != nil {
					cerbos_audit_v1_PolicySource_Database_hashpb_sum(t.Database, hasher, ignore, b)
				}
			case *PolicySource_Disk_:
				if t.Disk != nil {
					cerbos_audit_v1_PolicySource_Disk_hashpb_sum(t.Disk, hasher, ignore, b)
				}
			case *PolicySource_Git_:
				if t.Git != nil {
					cerbos_audit_v1_PolicySource_Git_hashpb_sum(t.Git, hasher, ignore, b)
				}
			case *PolicySource_Hub_:
				if t.Hub != nil {
					cerbos_audit_v1_PolicySource_Hub_hashpb_sum(t.Hub, hasher, ignore, b)
				}
			case *PolicySource_EmbeddedPdp:
				if t.EmbeddedPdp != nil {
					cerbos_audit_v1_PolicySource_EmbeddedPDP_hashpb_sum(t.EmbeddedPdp, hasher, ignore, b)
				}
			}
		}
	}
			...
			if len(m.Annotations) <= 32 {
				...
				for _, k := range keys {
					...
					if m.Annotations[k] != nil {
						google_protobuf_Value_hashpb_sum(m.Annotations[k], hasher, ignore, b)
					}
				}
				hashpb_stringKeyPool.Put(keys)
			} else {
